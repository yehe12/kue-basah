...
def bossDashboard():
    if 'loggedin' in session:
        if session['role'] == 1 :
            ...
            return render_template('boss/boss_dashboard.html', count_user=data_user, count_cost_total=data_cost_total, count_repair=data_repair, count_in_repair=data_in_repair)
